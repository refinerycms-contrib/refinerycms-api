...
module Refinery
  describe Api::V1::OrdersController, :type => :controller do
    ...
    context "with an available promotion" do
      ...
      let!(:promotion) do 
        promotion = Refinery::Promotion.create(name: "10% off", code: "10off")
        calculator = Refinery::Calculator::FlatPercentItemTotal.create(preferred_flat_percent: "10")
        action = Refinery::Promotion::Actions::CreateItemAdjustments.create(calculator: calculator)
