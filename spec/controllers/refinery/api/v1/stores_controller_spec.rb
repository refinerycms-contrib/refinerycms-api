...
module Refinery
  describe Api::V1::StoresController, type: :controller do
    ...
    let!(:store) do
      create(:store, name: "My Refinery Store", url: "refinerystore.example.com")
    end
    ...
    context "as an admin" do
      ...
      let!(:non_default_store) do
        create(:store,
          name: "Extra Store",
          url: "refinerystore-5.example.com",
          default: false
        )
      end
      ...
      it "I can list the available stores" do
        ...
        expect(json_response["stores"]).to eq([
          {
            "id" => store.id,
            "name" => "My Refinery Store",
            "url" => "refinerystore.example.com",
            "meta_description" => nil,
            "meta_keywords" => nil,
            "seo_title" => nil,
            "mail_from_address" => "refinery@example.org",
      ...
      it "I can update an existing store" do
        ...
        expect(store.reload.url).to eql "refinery123.example.com"
