module Refinery
  module Api
    module V1
      class LineItemsController < Refinery::Api::BaseController
        class_attribute :line_item_options

        self.line_item_options = []

        def create
          variant = Refinery::Variant.find(params[:line_item][:variant_id])
        ...
        private
          def order
            @order ||= Refinery::Order.includes(:line_items).find_by!(number: order_id)
