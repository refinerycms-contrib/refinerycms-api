module Refinery
  module Api
    module V1
      class VariantsController < Refinery::Api::BaseController
        ...
        private
          def product
            @product ||= Refinery::Product.accessible_by(current_ability, :read).friendly.find(params[:product_id]) if params[:product_id]
          end
