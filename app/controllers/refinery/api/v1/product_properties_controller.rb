module Refinery
  module Api
    module V1
      class ProductPropertiesController < Refinery::Api::BaseController
        ...
        def product_property
          if @product
            ...
            @product_property ||= @product.product_properties.includes(:property).where(refinery_properties: { name: params[:id] }).first
