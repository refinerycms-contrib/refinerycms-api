module Refinery
  module Api
    module V1
      class OrdersController < Refinery::Api::BaseController
        ...
        def create
          ...
          order_user = if @current_user_roles.include?('admin') && order_params[:user_id]
            Refinery.user_class.find(order_params[:user_id])
          else
            current_api_user
          end
          ...
          @order = Refinery::Core::Importer::Order.import(order_user, import_params)
        ...
        def update
          ...
          if @order.contents.update_cart(order_params)
            ...
            if current_api_user.has_refinery_role?('admin') && user_id
        ...
        def apply_coupon_code
          ...
          render "refinery/api/v1/promotions/handler", status: status
        end
        ...
        private
          ...
          def find_order(lock = false)
            @order = Refinery::Order.lock(lock).friendly.find(params[:id])
          end
